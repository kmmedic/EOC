    	...
    	driver.findElement(By.id("username")).clear();
  		...
  		for(WebElement li : tagname1){
  			...
  			Thread.sleep(3000);
  		    	 ...
  		    	 Thread.sleep(3000);
  		    	 WebElement trmtlist = driver.findElement(By.id("slidercontainertreatment"));
  		 	  	List<WebElement> tagname2 = trmtlist.findElements(By.className("rowSelection"));
  				...
  				for(WebElement tlist : tagname2){
  		    	 ...
  		    	 WebElement element1 = tlist.findElement(By.xpath("/html/body/div[3]/div[3]/div/div[2]/div/div[1]/div[2]/div[1]/div[1]"));
  		    	...
  		    	if(tdate.matches("28-04-2014") && tname.matches("Right  Hip  Replacement"))
  		    	 {
  		    	//Reporter.log("SD="+sd,true);
    		    	 // Action doubleClick1 = action1.doubleClick(element1).build();
    		    	// doubleClick1.perform();// After performing double click Map will load
    		    	 driver.findElement(By.xpath("/html/body/div[3]/div[3]/div/div[2]/div/div[1]/div[2]/div[1]/div[4]/img")).click();
    		    	 Thread.sleep(2000);
