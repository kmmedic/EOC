...
public class PatReviewAdd {
	@BeforeClass
	public void setup() throws Exception {
		PatTrmtAdd_S pattrmt=new PatTrmtAdd_S(); 
		  pattrmt.add();
	}
  ...
  @Test
  public void reviewadd() throws Exception {
 	...
 	// driver.findElement(By.className("clsapp_pat_treatment")).click();
	  driver.findElement(By.xpath("/html/body/div[3]/div[3]/div/div[3]/div/div/div/div/ul/li[2]/a/span")).click();
	  WebElement table = driver.findElement(By.className("flex_treatment"));
		...
		for(WebElement li : tagname1){
			...
			Thread.sleep(3000);
				 ...
				 WebElement element1 = li.findElement(By.xpath("/html/body/div[3]/div[3]/div/div[2]/div/div/div[7]/table/tbody/tr["+i+"]/td[2]/div"));
		    	 String tdate=li.findElement(By.xpath("/html/body/div[3]/div[3]/div/div[2]/div/div/div[7]/table/tbody/tr["+i+"]/td[2]/div")).getText();
		    	 
		    	 WebElement element = li.findElement(By.xpath("/html/body/div[3]/div[3]/div/div[2]/div/div/div[7]/table/tbody/tr["+i+"]/td[3]/div"));
		    	 String tname=li.findElement(By.xpath("/html/body/div[3]/div[3]/div/div[2]/div/div/div[7]/table/tbody/tr["+i+"]/td[3]/div")).getText();
		    	 Reporter.log("Trmt Date="+tdate+"SD="+tname+"-------------",true);
		    	 i++;
		    	 if(tdate.matches("Gogarty"))
		    	 {
		    		 Reporter.log("SD="+tdate,true);
