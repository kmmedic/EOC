  				...
  				for(WebElement rlist : tagname3){
  					Thread.sleep(3000);
  			    	 ...
  			    	 if(rname.equals("6 month review"))
  			    	 {
  				    	...
  				    	String selfcare = "//input[contains(@class, 'leftmenuBox') and contains(@value, 'Oxford Hip Score Questionnaire')]";
