  	 ...
  	 //try{
  		...
  		for(WebElement li : tagname1){
  			...
  			Thread.sleep(3000);
  		    	 ...
  		    	 {
  		    		Thread.sleep(3000);
  		    		driver.findElement(By.xpath("/html/body/div[3]/div[3]/div/div[2]/div[2]/div[2]/div/div[7]/table/tbody/tr["+i+"]/td/div")).click();
  		    		 Reporter.log("SD="+sd,true);
  					...
  					Thread.sleep(3000);
  			    	 ...
  			    	 if(rname.equals("In-Patient Stay"))
  			    	 {
				    	 ...
				    	 WebElement euroyes = driver.findElement(By.xpath(euroq));
  				    	...
  				    	String b[][]= datap.getTableArray("C:\\QAA\\HipOperationData.xls",0);
  				      int brow=1;
  				      int bcol=0;
  				      Thread.sleep(2000);
